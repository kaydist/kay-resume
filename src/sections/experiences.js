...
function Experiences() {
  return (
    <div
      className="py-16 md:min-h-screen start professionalExperience"
    ...
    >
      <div>
        ...
        <div className="experience-overflow mt-14 overflow-x-auto overflow-y-hidden md:max-w-[60vw]">
          <div
            ...
            <div className="min-w-[65vw] panel">
              <div className="md:max-w-[70%] paragraph">
                <p>
                  ...
                  <ul className="mt-5 list-disc list-inside text-left">
                    <li className="mb-4">
                      Collaborated with the design team in revamping the web
                      app’s user interface for a top-notch experience.
                    </li>
                    <li className="mt-4">
                      Architected and Developed New Client-Side dashboard.
                    </li>
                    <li className="mt-4">
                      Integrated anonymous donator feature to the new Client
                      Side.
                    </li>
                  </ul>
                </p>
                ...
                <p>
                  ...
                  <ul className="mt-5 list-disc list-inside text-left">
                    <li className="mb-4">
                      ...
                      organization’s Marketplace App for installation of
                      plugins.
                    </li>
                    <li className="mt-4">
                      Improved Client-Client communication speed on
                      organization’s Noticeboard App by 3seconds by integration
